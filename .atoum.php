...
if(!file_exists('/home/travis'))
{
    ...
    $coverageField = new atoum\report\fields\runner\coverage\html('BFW Controller', '/home/bfw-website/www_reports/bfw-controller-v3/test-unit');
    $coverageField->setRootUrl('http://bfw.bulton.fr/reports/bfw-controller-v3/test-unit/index.html');
    $report->addField($coverageField);
    
    $treemapField = new atoum\report\fields\runner\coverage\treemap('BFW Controller', '/home/bfw-website/www_reports/bfw-controller-v3/treemap');
    $treemapField->setHtmlReportBaseUrl('http://bfw.bulton.fr/reports/bfw-controller-v3/treemap/index.html');
...
if(file_exists('/home/travis'))
{
    ...
    $sources = './src';
    $token = '725NDVfV6EgyEujJftIZxaULbHpJgyLjA';
